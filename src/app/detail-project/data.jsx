export const projectDetails = [
    {
        ...
        gitUrl: "",
        dutys: [
            "Developed and designed a web-based Intern Leaderboard using Angular, ASP.NET Core, and SQL Server, integrating data from Jira",
            "The system allows users to search, filter, and visualize task data through graphs for clear performance analysis"
        ]
    },
    {
        id: 2,
        ...
        dutys: [
            "Developed an online homework submission platform using React.js, Tailwind CSS, Node.js and PostgreSQL",
            "Implemented robust file management features (upload, update, delete) using Cloudinary , supporting multiple formats including DOCX, PDF, and various image files.",
            "Implemented real-time notifications for assignment creation and homework submission using Socket.IO"
        ]
    },
    {
        id: 3,
        ...
        dutys: [
            "Developed backend features with PHP to handle order management, including tracking order status",
            "Developed a responsive HTML CSS JavaScript Bootstrap",
            "Integrated MySQL for products, users, and order history"
        ]
    },
    {
        id: 4,
        ...
        dutys: [
            "Developed a web-based simulation of Multilevel Queue Scheduling using HTML, CSS, JavaScript, and Bootstrap",
            "Implemented features to visualize CPU access requests and scheduling based on priority levels"
        ]
    },
    {
        id: 5,
        ...
        dutys: [
            "Developed a real-time chat application using Next.js, Tailwind CSS, Socket.IO, and PostgreSQL",
            "Implemented user authentication, one-on-one and group messaging features",
        ]       
    }
